...
//    val logFile = new File(this.getClass.getClassLoader.getResource("README.MD").toURI).getPath
    ...
    val logFile = new File("/Users/jerry/Downloads/wxget.log").getPath
    //val logFile = "hdfs://master:9000/wordcount/README.md"
    val conf = new SparkConf().setAppName("Simple Application").setMaster("local[*]")
//    val conf = new SparkConf().setAppName("Simple Applicati on").setMaster("spark://master:7077")
    ...
    counts.collect().sortBy(_._2).foreach(println)
